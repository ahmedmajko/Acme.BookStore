...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 58d9464b-e1ef-4746-b486-a68735c3828a
```

> `58d9464b-e1ef-4746-b486-a68735c3828a` is the password of the certificate, you can change it to any password you want.
